...
},{"./data":10,"d3-geo":2,"spencer-color":5,"topojson-client":6}],9:[function(_dereq_,module,exports){
"use strict";
...
var Graticule = _dereq_('./shapes/Graticule');
...
function () {
  ...
  _createClass(World, [{
    key: "mercator",
    value: function mercator() {
      this.projection = d3Geo.geoMercator().scale(450);
    }
  }, {
    key: "globe",
    value: function globe() {
      this.projection = d3Geo.geoOrthographic().scale(958).translate([-190, -590]).rotate([77, -51, 0]);
    }
  }, {
    key: "background",
    value: function background(str) {
      var shape = new Background(str, this);
    ...
    key: "graticule",
    value: function graticule(obj) {
      var dot = new Graticule(obj, this);
      this.shapes.push(dot);
      return dot;
    }
  }, {
    ...
    value: function build() {
      ...
      elements = elements.concat(this.back.map(function (sh) {
        return sh.build();
      }));
      var attrs = {
        width: this.width,
...
},{"./Background":8,"./data":10,"./shapes/Dot":21,"./shapes/Graticule":22,"./shapes/Line":23,"./shapes/Shape":24,"./shapes/Text":25,"d3-geo":2,"fit-aspect-ratio":3,"htm":4,"vhtml":7}],10:[function(_dereq_,module,exports){
"use strict";
...
module.exports = {
  shapes: {
    ...
    land: _dereq_('./shapes/land'),
    'north-america': _dereq_('./shapes/north-america'),
    world: _dereq_('./shapes/countries'),
    states: _dereq_('./shapes/states')
  },
  points: _dereq_('./points/index')
};

},{"./points/index":12,"./shapes/countries":15,"./shapes/great-lakes":16,"./shapes/land":17,"./shapes/north-america":18,"./shapes/states":19}],11:[function(_dereq_,module,exports){
"use strict";
...
},{"./World":9}],21:[function(_dereq_,module,exports){
"use strict";
...
},{"./Shape":24,"spencer-color":5}],22:[function(_dereq_,module,exports){
"use strict";

function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = _taggedTemplateLiteral(["<g>", "</g>"]);
...
function (_Shape) {
  ...
  function Graticule() {
    ...
    obj = Object.assign({}, defaults, obj);
    return _possibleConstructorReturn(this, _getPrototypeOf(Graticule).call(this, obj, world));
  }
  ...
  _createClass(Graticule, [{
    ...
    value: function build() {
      ...
      var projection = this.world.projection;
      var toPath = d3Geo.geoPath().projection(projection);
      var grat = d3Geo.geoGraticule().step([4, 4]);
      var lines = grat.lines();
      lines = lines.map(function (line) {
        var d = toPath(line);
        var attrs = Object.assign({}, _this.attrs, {
          id: _this._id,
          d: d
        });
        return h(_templateObject(), attrs);
...
},{"./Shape":24,"d3-geo":2,"spencer-color":5}],23:[function(_dereq_,module,exports){
"use strict";
...
},{"../data":10,"./Shape":24,"d3-geo":2,"spencer-color":5}],24:[function(_dereq_,module,exports){
"use strict";
...
},{"../data":10,"d3-geo":2,"spencer-color":5,"topojson-client":6}],25:[function(_dereq_,module,exports){
"use strict";
