...
var banner =
  '/* somehow-maps v' + pkg.version + '\n   github.com/spencermountain/somehow-maps\n   MIT\n*/\n'
var uncompressed = './builds/somehow-maps.js'
var compressed = './builds/somehow-maps.min.js'
...
var cmd = browserify + ' ./src/index.js --standalone somehowMaps'
